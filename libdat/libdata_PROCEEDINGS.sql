...
CREATE TABLE `PROCEEDINGS` (
  ...
  `CEDITOR` varchar(40) NOT NULL,
  `DOCID` int NOT NULL,
  PRIMARY KEY (`DOCID`),
  CONSTRAINT `proceedings_ibfk_1` FOREIGN KEY (`DOCID`) REFERENCES `JOURNAL_VOLUME` (`DOCID`)
...
INSERT INTO `PROCEEDINGS` (`CDATE`, `CLOCATION`, `CEDITOR`, `DOCID`) VALUES ('2022-10-25','New jersey','Alex',2);
